...
J'ai coordonné des équipes et des événements en association pendant deux ans : l'accueil client, le rythme soutenu et le travail en équipe ne me font pas peur.

Est-ce qu'il y a un besoin en ce moment dans votre magasin, ou une personne à qui je devrais m'adresser ? Je peux repasser déposer mon CV si c'est plus simple.
...
## Notes
- Il **rappelle un fait concret** (le CV déposé) : tu n'es pas une inconnue.
- Ta **disponibilité arrive avant la demande** : c'est ce qu'un directeur de magasin veut savoir en premier.
- Le timing est bon : la fin d'année est la période la plus chargée pour Sephora.
- Ne parle pas de « conseil » ni d'AST : ici, ce qui compte c'est ta disponibilité et ta fiabilité.
- Ne mentionne pas ton titre de séjour dans ce premier message : tu en parleras au moment du contrat.

## Après l'envoi
- Cocher dans `REGISTRE_ENVOIS_CLEANNE.md` (RC-11).
